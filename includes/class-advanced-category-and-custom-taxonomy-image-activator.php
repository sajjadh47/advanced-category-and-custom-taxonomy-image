<?php
/**
 * This file contains the definition of the Advanced_Category_And_Custom_Taxonomy_Image_Activator class, which
 ...
 * @since    2.0.0
 */
class Advanced_Category_And_Custom_Taxonomy_Image_Activator {
	/**
	 * Activation hook.
	 *
